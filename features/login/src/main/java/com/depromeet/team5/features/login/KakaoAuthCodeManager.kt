...
class KakaoAuthCodeManager @Inject constructor(
    ...
    suspend fun authorize(): Result<Pair<String, String>> = coroutineScope {
    ...
    private suspend fun authorizeWithKakaoTalk() = suspendCancellableCoroutine { continuation ->
    ...
    private suspend fun authorizeWithAccount() = suspendCancellableCoroutine { continuation ->
